...
CREATE TABLE paquetes(
    ...
    id_tipo_paquete INT, #1 Sorpresa 2 Detallado
...
INSERT INTO paquetes(nombre, descripcion, id_tipo_paquete)
	VALUES
    ("Papitas fritas Mistery", "Papitas fritas :D", 1),
    ("Trio de bowls sorpresa", "Tres bowls M a eleccion", 1),
    ("Panetones random", "Dos panetones de sabor variado", 2);
...
INSERT INTO inventarios(codigo, precio, stock, id_comercio, id_paquete)
	VALUES
    ("1", 75, 20, 1, 1),
    ("1", 60, 30, 2, 2),
    ("1", 30, 10, 3, 3);
